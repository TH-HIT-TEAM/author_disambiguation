...
with open(os.path.join("author_disambiguation", "__init__.py"), "rt") as f:
    _version = re.search(
...
_parameters = {
    ...
    "author_email": "author_disambiguation@invenio-software.org",
    ...
    "name": "author_disambiguation",
    "packages": packages,
    "platforms": "any",
    "tests_require": _tests_require,
    "url": "https://github.com/inveniosoftware/author_disambiguation",
    "version": _version,
}
